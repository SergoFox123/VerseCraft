...
import static net.sergofox123.versecraft.VerseSharedConstants.MOD_ID;
import net.sergofox123.versecraft.VersePreLoadConstants;
...
public final class WorldgenConfig {
	...
	public static final Config<WorldgenConfig> INSTANCE = ConfigRegistry.register(
		new JsonConfig<>(
			...
			VersePreLoadConstants.configPath("worldgen", true),
			JsonType.JSON5,
			null,
			null
		) {
